const CACHE_NAME = "gov-support25-site-v146";
const ASSETS = [
  "./",
  "./styles.css?v=10",
  "./desktop.css",
  ...
  "./policy-detail.css?v=3",
  "./category-app-style.css?v=5",
  "./category-app-style.css?v=7",
  "./popular-filter-fix.css?v=1",
  "./popular-filter-fix.css?v=2",
  "./popular-filter-fix.css?v=3",
  "./popular-filter-fix.css?v=4",
  "./source-compliance-fix.css?v=1",
  "./home-focus.css?v=2",
  "./deadline.js?v=2",
  "./deadline.js?v=3",
  "./deadline.js?v=4",
  ...
  "./policy-live-detail.js?v=10",
  "./policy-live-detail.js?v=11",
  "./policy-detail-actions.js?v=1",
  "./policy-detail-actions.js?v=3",
  "./policy-detail-actions.js?v=4",
  "./policy-detail-actions.js?v=6",
  "./policy-detail-actions.js?v=7",
  "./app-shell.js?v=1",
  "./app-shell.js?v=2",
  "./official-links.js?v=6",
  "./official-links.js?v=7",
  "./official-links.js?v=8",
  "./official-links.js?v=9",
  "./official-links.js?v=10",
  "./policy-shell.js?v=1",
  "./deadline-badge-fix.js?v=1",
  "./deadline-badge-fix.js?v=2",
  "./mobile-search-action.js?v=3",
  "./site.js?v=24",
  "./site.js?v=25",
  "./site.js?v=26",
  "./search-fix.js?v=2",
  ...
  "./gwangju-region-api-fix.js?v=1",
  "./search-stability-fix.js?v=1",
...
self.addEventListener("fetch", (event) => {
  ...
  const networkFirst =
    ...
    url.pathname.endsWith("/gwangju-region-api-fix.js") ||
    url.pathname.endsWith("/search-stability-fix.js") ||
    url.pathname.endsWith("/loading-copy-fix.js") ||
    url.pathname.endsWith("/repeat-search-reset-fix.js") ||
    url.pathname.endsWith("/source-compliance-fix.js") ||
    url.pathname.endsWith("/source-compliance-fix.css") ||
    url.pathname.endsWith("/api-source-notice.js") ||
